...
SZ.DisplayObject = function() {
	...
	var _getX = function() {return 0 + _x;};
	...
	var _getScaleY = function() {return 0 + _y;};
	...
	var _getY = function() {return 0 + _y;};
...
//	};
	...
	return {id:_name, x:_getX, y:_getY, setX:_setX, setY:_setY, parent:_parent, children:_children, addChild:_addChild, removeChild : _removeChild, graphics:graphics, invalidate:_invalidate};
};