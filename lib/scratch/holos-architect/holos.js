...
// Create relative tree
        ...
        var app = architect.createApp(tree, function () {
            ...
            //logger.debug('app.services.hub.emit is ... ', app.services.hub.emit);
...
// Start application!
    ...
    function processPlugins(app) {
        ...
        //logger.debug('app.config is ... ', app.hub);
        //
        //logger.debug('app.services.eventbus is ... ', app.services.eventbus);
        //H.eventbus =

        //logObject(app);
        //logger.debug('app.services.eventbus is ... ', app.services);

        //H.eventbus = app.services.eventbus;
        //H.version = app.services.version;

        //var plugins = require('./package.json').plugins;
        ////logger.debug('plugins is ... ', plugins);
        //
        //_.each(plugins,function(plugin){
        //    assert.equal(!!app.services[plugin], true,
        //        "Plugin '" +plugin+
        //        "' doesn't exist");
        //    H[plugin]=app.services[plugin];
        //});
        //
        //for(var prop in app.services) {
        //    //logger.debug('prop is ... ', prop);
        //    H[prop]=app.services[prop];
        //}
        //H.version =
